...
tool_descriptions = get_tools_descriptions = get_tools_descriptions(tools)
tool_names = ", ".join(tools.keys())

react_prompt = f"""
STRICT_RULES - you must follow these exactly:
1. NEVER guess or assume any product price. You MUST call get_product_price first to get the real price.
2. Only call apply_discount AFTER you have received a price from get_product_price. Pass the exact price returned by get_product_price - 
...
def run_agent(question: str):
	...
	for iteration in range(1, MAX_ITERATIONS +1):
		...
		# Parse tool_call from the LLM itself
